					...
					<!--FORM -->
						<form action="edit_post.php" method="post">
							<div class="form-group">
									...
									<input type="date" name="date"  class="r-form-1-first-name form-control" id="r-form-1-first-name" value="<?php echo $_SESSION['date']; ?>" >
							</div>
							<div class="form-group">
									<label class="sr-only" for="r-form-1-first-name">Kategoria</label>
									<input type="text" name="category" placeholder="Kategoria..." class="r-form-1-first-name form-control" id="r-form-1-first-name" value="<?php echo $_SESSION['category']; ?>" >
								</div>
							<div class="form-group">
									...
									value="<?php echo $_SESSION['topic']; ?>" />
							</div>
							<div class="form-group">
									<textarea name="content" placeholder="Treść..." 
									class="r-form-1-about-yourself form-control" id="r-form-1-about-yourself"><?php echo htmlspecialchars($_SESSION['content']);?></textarea>
							</div>
							<button type="submit" class="btn" name="update_record" >Zapisz wpis</button><br>
						</form>
