			...
			<div class="row">
					<div class="col-sm-8 col-sm-offset-2 text">
						...
						<div class="description wow fadeInLeftBig">
							<h2> Twoje życie zapisane w notatkach. </h2>
						</div>
					</div>
				</div>
						...
						<div class="r-form-1-bottom">
							<form method="post" action="register_view.php">
								<div class="form-group">
									<label class="sr-only" for="r-form-1-first-name">Login</label>
									<input type="text" name="username" placeholder="Login..." class="r-form-1-first-name form-control" id="r-form-1-first-name" value="<?php echo $username; ?>">
								</div>
								<div class="form-group">
